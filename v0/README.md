...
- `format`: a string specifying the input file format.
...
- `files`: an array of objects specifying the position of each file in the remaining bytes (i.e., following the Gzipped JSON).
...
- `annotations`: Object containing the provided cell annotations.
